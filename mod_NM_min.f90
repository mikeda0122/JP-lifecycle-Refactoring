...
contains
  ...
  subroutine nelmin(n, start, xmin, ynewlo, reqmin, step, konvge, kcount, icount, numres, ifault)
    ...
    !    calling routine and passed as the argument GMM.
    !
    ...
    !  Parameters:
    !
    !    Input, external GMM, the name of the function which evaluates
    ...
    do
       ...
       do while ( icount < kcount )
          ...
          ystar = gmm ( pstar )
          icount = icount + 1 ; write(*,*) 'iteration', icount
          !
          ...
          if ( y(ihi) < ylo ) then
             ...
             !write(1,'(f18.10, a, f18.10, a, f18.10, a, f18.10, a, f18.10, a, f18.10, a, f18.10, a, f18.10)')p(1:n,ilo), y(ilo)
             write(1,*) p(1:n,ilo), y(ilo)
