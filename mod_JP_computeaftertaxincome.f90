...
!    real(8) :: tbk_h(12), tbk_s(7), deduct_s(7), HI(12), Pen(12), HI_e(12)
    ...
    open(unit = 10, iostat = ios, file = 'ss_params/tbk_h_H28.csv', action = 'read', form = 'formatted', &
           & status = 'old')
           if (ios /= 0) then
    ...
    open(unit = 11, iostat = ios, file = 'ss_params/HI_H28.csv', action = 'read', form = 'formatted', &
           & status = 'old')
           if (ios /= 0) then
             write(*,*) 'Failed to open!'
             stop
    ...
    open(unit = 12, iostat = ios, file = 'ss_params/HI_e_H28.csv', action = 'read', form = 'formatted', &
           & status = 'old')
           if (ios /= 0) then
             write(*,*) 'Failed to open!'
             stop
      ...
      open(unit = 13, iostat = ios, file = 'ss_params/Pen_H28.csv', action = 'read', form = 'formatted', &
           & status = 'old')
           if (ios /= 0) then
             write(*,*) 'Failed to open!'
             stop
...
!    taxableY_s = Y ‚œ kojyo_s 
!    taxableY_j = Y ‚œ kojyo_j 
